...
namespace GasDustTest
{
    public partial class Form2 : Form
    {
        ...
        private void bNext_Click(object sender, EventArgs e)
        {
            ...
            switch (step)
            {
                ...
                case 2:
                    ...
                    AddLabel("Перед определением содержания смолы и пыли в газе наполните две трубки \nгигроскопической ватой, третью трубку наполните свежепрокаленым \nхлористым кальцием.\nЗакройте трубки пробками и соедините в последовательности: \nвата - хлористый кальций - вата.\nИспытайте на герметичность.");
                    break;
                case 3:
                    lHeader.Text = "Подготовка трубок";
                    AddTimer(1500, "Присоедините первую трубку (с ватой) к газовому счётчику, \nтретью трубку (с ватой) присоедините к газопроводу. \nПропустите через трубки газ в течении 20-30 минут со скоростью 75-80 дм³/ч. \nПо прошествии времени отсоедините трубки от газопровода и счётчика, \nразъедините друг от друга и закройте.");
                    break;
                case 4:
                case 8:
                ...
                case 10:
                    ...
                    break;
                case 11:
                    ZeroCheck((active as UserControls.VolumeInput).volume, "Объём газа не может быть равен нулю");
                    if (V1 == 0)
                    ...
                    AddLabel("За результат испытания принимают среднеарифметическое двух параллельных определений, \nдопускаемые расхождения между которыми не должны \nпревышать 0,05 г. на 100 м³.");
                    break;
                case 12:
                    step = 2;
                    bNext_Click(sender, e);
        ...
        private void ZeroCheck(decimal value, string message) {
            if (value == 0)
            {
                step -= 2;
